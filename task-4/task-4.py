...
import http.client
import json
bot = telebot.TeleBot('1852581211:AAHAy72j83NC5UETw41kB1qXTWPAiywkIu8')
...
def lala(message):
    bot.send_message(message.chat.id,
                     '/start - вся инфа\n/update - обновлённая\n/save - сохранить в файл\n/Turkey - инфа Turkey\n/Iran - инфа Iran\n/Indonesia - инфа Indonesia\n/Philippines - инфа Philippines\n/Iraq - инфа Iraq\n/search - поиск по странам')
...
def start_handler(message):
    ...
    text = message.text
    msg = bot.send_message(chat_id, 'Какая страна?')
    bot.register_next_step_handler(msg, askCountry)
...
def askCountry(message):
        ...
        if (text != c5 and text != c4 and text != c3 and text != c2 and text != c1):
            ...
            bot.register_next_step_handler(msg, askCountry)  # askSource
            return
